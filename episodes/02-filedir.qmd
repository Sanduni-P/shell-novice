...
![](fig/filesystem.svg){alt='The file system is made up of a root directory that contains sub-directories titled bin, data, users, and tmp' fig-align="center"}
...
![](fig/home-directories.svg){alt='Like other directories, home directories are sub-directories underneath "/Users" like "/Users/imhotep", "/Users/larry" or"/Users/nelle"' fig-align="center"}
...
Desktop directory, including the `shell-lesson-data` directory you downloaded at the [prerequisites for this lesson](../index.qmd#prerequisites). (On most systems, the
...
![](fig/shell_command_syntax.svg){alt='General syntax of a shell command' fig-align="center"}
...
<table style="width: 100%; border: none;">
  <tr>
    <td style="text-align: left; width: 50%;">
      [← Previous](../episodes/01-intro.qmd)
    </td>
    <td style="text-align: right; width: 50%;">
      [Next →](../episodes/03-create.qmd)
    </td>
  </tr>
</table>
