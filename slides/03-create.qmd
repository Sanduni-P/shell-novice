...
- Verify the directory is empty (since we just created it):
...
- For names with spaces or special characters, wrap the name in quotes:
...
- **Wildcards** represent unknown characters or character sets.
...
- The shell expands wildcards to matching filenames **before** running a command.
