...
- Use **short options** for quick interactive work:
...
- Unsupported options return an error message:
...
- `man ls` opens the manual page for `ls` and its options.
...
- If `Desktop` does not exist in your current working directory, this command returns an error.
